...
const Cadastro = () => {
  ...
  const campos = [
    { tipo: "text", placeholder: "Nome:", name: "name", value: formData.name, onChange: handleChange, icone: "/icones/User_Icone.png" },
    { tipo: "email", placeholder: "Email:", name: "email", value: formData.email, onChange: handleChange, icone: "/icones/User_Icone.png" },
    { tipo: "password", placeholder: "Senha:", name: "password", value: formData.password, onChange: handleChange, icone: "/icones/Password_Icone.png" },
  ];
